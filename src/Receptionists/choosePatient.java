...
public class choosePatient extends javax.swing.JFrame {
        ...
        jPanel7Layout.setHorizontalGroup(
                jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel7Layout.createSequentialGroup()
                                .addGap(510, 510, 510)
                                .addComponent(jLabel14, javax.swing.GroupLayout.PREFERRED_SIZE, 169,
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_jLabel2MouseClicked
        ...
        String sql = "select date,id,name,age,gender,address,phone,status,disease,room from patient where name = '"
                + searchKey + "'";
        try {
    ...
    private void dASearchbtn1MouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_dASearchbtn1MouseClicked
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null,
                    "PATIENT " + pname + " Appointmented with DOCTOR " + dName + " at room no " + droom);
