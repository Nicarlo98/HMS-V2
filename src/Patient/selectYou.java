...
public class selectYou extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel14.setText("Your Name Patient");
    ...
    private void jLabel21MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel21MouseClicked
        doctorChoice dc = new doctorChoice();
        dc.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(selectYou.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
